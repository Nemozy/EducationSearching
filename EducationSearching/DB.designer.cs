...
namespace EducationSearching
{
    ...
    partial void Insertwebpages_UsersInRoles1(webpages_UsersInRoles1 instance);
    partial void Updatewebpages_UsersInRoles1(webpages_UsersInRoles1 instance);
    partial void Deletewebpages_UsersInRoles1(webpages_UsersInRoles1 instance);
    #endregion
		...
		public System.Data.Linq.Table<webpages_UsersInRoles1> webpages_UsersInRoles1
		{
			get
			{
				return this.GetTable<webpages_UsersInRoles1>();
			}
		}
	}
	...
	public partial class webpages_Roles : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<webpages_UsersInRoles1> _webpages_UsersInRoles1;
    ...
    partial void OnRoleNameChanged();
		...
		public webpages_Roles()
		{
			...
			this._webpages_UsersInRoles1 = new EntitySet<webpages_UsersInRoles1>(new Action<webpages_UsersInRoles1>(this.attach_webpages_UsersInRoles1), new Action<webpages_UsersInRoles1>(this.detach_webpages_UsersInRoles1));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="webpages_Roles_webpages_UsersInRoles1", Storage="_webpages_UsersInRoles1", ThisKey="RoleId", OtherKey="RoleId")]
		public EntitySet<webpages_UsersInRoles1> webpages_UsersInRoles1
		{
			get
			{
				return this._webpages_UsersInRoles1;
			}
			set
			{
				this._webpages_UsersInRoles1.Assign(value);
			}
		}
		...
		private void attach_webpages_UsersInRoles1(webpages_UsersInRoles1 entity)
		{
			this.SendPropertyChanging();
			entity.webpages_Roles = this;
		}
		
		private void detach_webpages_UsersInRoles1(webpages_UsersInRoles1 entity)
		{
			this.SendPropertyChanging();
			entity.webpages_Roles = null;
		}
    ...
    partial void OnFIOShortChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UserProfile_webpages_UsersInRoles1", Storage="_webpages_UsersInRoles1", ThisKey="UserId", OtherKey="UserId")]
		public EntitySet<webpages_UsersInRoles1> webpages_UsersInRoles1
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.webpages_UsersInRoles")]
	public partial class webpages_UsersInRoles1 : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnRoleIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="webpages_Roles_webpages_UsersInRoles1", Storage="_webpages_Roles", ThisKey="RoleId", OtherKey="RoleId", IsForeignKey=true)]
		public webpages_Roles webpages_Roles
		{
			get
			{
			...
			set
			{
							...
							|| (this._webpages_Roles.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._webpages_Roles.Entity = null;
						previousValue.webpages_UsersInRoles1.Remove(this);
					}
					this._webpages_Roles.Entity = value;
					if ((value != null))
					{
						value.webpages_UsersInRoles1.Add(this);
						this._RoleId = value.RoleId;
					}
					else
					{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="UserProfile_webpages_UsersInRoles1", Storage="_UserProfile", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public UserProfile UserProfile
		{
			get
			{
